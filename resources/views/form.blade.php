...
@section('content')
@include('navbar')
<div class="w-full min-h-screen flex justify-center items-center p-5 pt-[50px] bg-black">
<div class="absolute top-0 left-0 w-full h-screen bg-cover bg-center" style="background-image: url('{{ asset('assets/rempah_bg.jpeg') }}')"></div>
    <div class="bg-[rgba(0,0,0,0.3)] backdrop-blur-[20px] rounded-xl border border-white">
        <div class="overflow-y-auto max-h-[80vh] p-6 overflow-x-hidden">
            <form id="recipeForm" action="" method="POST" enctype="multipart/form-data"
            x-data="{ password: '', password_confirm: '' }"
            class="w-[95vw] sm:w-[69vw] lg:max-w-4xl flex-col mx-auto mb-10 no-border px-12 pt-1 rounded-md">
                @csrf     
                <div class="gap-3 md:gap-10 mb-5 md:mb-10 sm:mx-2">
                    ...
                    <div class="w-full">
                        ...
                        <div class="grid grid-cols-1 mb-5 md:mb-10 sm:mx-2">
                            <!-- Deskripsi Singkat -->
                            <div class="flex-col">
                                <label for="description" class="block mb-2 text-[3.5vw] sm:text-sm font-medium text-white">Deskripsi Singkat</label>
                                <div class="flex">
                                    <textarea name="description" id="description"
                                        class="rounded-none rounded-e-lg bg-transparent backdrop-blur-2xl border border-gray-300 text-white focus:ring-[var(--sand1)] focus:border-[var(--sand1)] block flex-1 min-w-0 w-full text-[3.5vw] sm:text-sm p-1.5 sm:p-2.5"
                                        placeholder="Masukan Deskripsi Singkat Hidangan..."></textarea>
                                </div>
                            </div>
                        </div>
