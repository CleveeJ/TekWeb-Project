...
<section class="bg-[#c9d6ff] bg-[linear-gradient(to_right,_#e2e2e2,_#c9d6ff)] flex items-center justify-center flex-col h-screen">
    ...
    <div class="konten bg-[#fff] rounded-[30px] [box-shadow:0_5px_15px_rgba(0,_0,_0,_0.35)] relative overflow-hidden w-[768px] max-w-full min-h-[480px]" id="konten">
        ...
        <div class="form-konten sign-in absolute top-[0] h-full transition-all ease-in-out duration-700 left-[0] w-1/2 z-2">
            <form class="bg-[#fff] flex items-center justify-center flex-col px-[40px] py-[0] h-full">
        ...
        <div class="toggle-konten absolute top-[0] left-2/4 w-1/2 h-full overflow-hidden transition-all ease-in-out duration-700 rounded-tl-[150px] rounded-br-[0] rounded-tr-[0] rounded-bl-[100px] z-[1000]">
            <div class="toggle bg-[#512da8] h-full bg-[linear-gradient(to_right,_#5c6bc0,_#512da8)] text-[#fff] relative -left-full w-[200%] translate-x-[0] transition-all ease-in-out duration-700">
                <div class="toggle-panel toggle-left absolute w-1/2 h-full flex items-center justify-center flex-col px-[30px] py-[0] text-center top-[0] translate-x-[0] transition-all ease-in-out duration-700 -translate-x-[200%]">
                    <h1 class="font-semibold text-lg">Already have account?</h1>
                ...
                <div class="toggle-panel toggle-right absolute w-1/2 h-full flex items-center justify-center flex-col px-[30px] py-[0] text-center top-[0] translate-x-[0] transition-all ease-in-out duration-700 right-[0] translate-x-[0]">
                    <h1 class="font-semibold text-lg">Don't have account?</h1>
